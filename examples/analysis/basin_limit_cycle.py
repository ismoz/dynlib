...
from dynlib.plot import series, export, basin_plot, fig, phase

# Energy Template Oscillator (ETO) with Circular L Curve
sim = setup("builtin://ode/eto-circular", jit=True, disk_cache=False, stepper="rk4")
# Globally stable limit cycle parameters
sim.assign(mu=0.8, a=2.0)
sim.create_snapshot("snap0")
